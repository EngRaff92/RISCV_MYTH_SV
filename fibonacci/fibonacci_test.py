...
@pytest.mark.parametrize("parameters", [{"END_COUNT" : "144", "DUMP_NAME" : "fibonacci_dump"}])
...
@pytest.mark.parametrize("parameters", [{"END_COUNT" : "144", "DUMP_NAME" : "fibonacci_piped_dump"}])
def test_fibonacci_piped(parameters):
    run(
        verilog_sources     = ["./pipe_ff.sv","./clock_g.sv","./fibonacci_piped.sv",],
